...
For more information on using data labels in Federated Audience Composition, please read the [apply access labels section](../compositions/compositions.md#access-labels){target="_blank"}.
