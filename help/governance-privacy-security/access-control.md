...
For more information on applying access labels to a composition, please read the [apply access labels section](/help/compositions/home.md#access-labels) of the compositions guide.
